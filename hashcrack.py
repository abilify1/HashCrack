...
if (pilih == '1') or (pilih == '01'):
 menu1 = [kuni+'Base85','\x1b[33mBase64','\x1b[33mBase32',kuni+'Base16',kuni+'MD5 (hex)']
...
if (pilih == '2') or (pilih == '02'):
 menu2 = [kuni+'Base85','\x1b[33mBase64','\x1b[33mBase32',kuni+'Base16']
